class proportional2(object):
    ...
    def __getitem__(self, ascii_code):
        ...
        # Return simplified '°' symbol
        elif ascii_code == 0xF8:
            #btimap = [0x06, 0x09, 0x09, 0x06, 0x00, 0x00, 0x00, 0x00]
            #bitmap = [0x04, 0x0a, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00]
            bitmap = [0x06, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]
            return self._trim(bitmap) + [0]
        else:
            return self._trim(bitmap) + [0]
